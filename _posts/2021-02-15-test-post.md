...
author: tactinix
date: 2021-02-15
categories: [Notes, Walk-throughs]
tags: [typography, test, test2]
math: true
mermaid: true
---

This post is a test post to show Markdown syntax rendering on [**Chirpy**](https://github.com/cotes2020/jekyll-theme-chirpy/fork), you can also use it as an example of writing. Now, let's start looking at text and typography.
